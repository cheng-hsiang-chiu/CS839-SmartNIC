...
sudo gcc -L ../../../lib/aarch64-linux-gnu/ -Wno-missing-braces -D DOCA_ALLOW_EXPERIMENTAL_API graph_main.c graph_sample.c ../../common.c ../../../applications/common/src/utils.c -I../../../applications/common/src/ -I../ -I../../ -I ../../../ -I../../../include/ -ldoca_common -ldoca_dma -ldoca_sha -o graph_sample

echo "Start to compile Pthread code"
echo ""
sudo gcc -L ../../../lib/aarch64-linux-gnu/ -Wno-missing-braces -D DOCA_ALLOW_EXPERIMENTAL_API pthread_sample.c ../../common.c ../../../applications/common/src/utils.c -I../../../applications/common/src/ -I../ -I../../ -I ../../../ -I../../../include/ -ldoca_common -ldoca_dma -ldoca_sha -o pthread_sample

echo "Start to compile sequential code"
echo ""
sudo gcc -L ../../../lib/aarch64-linux-gnu/ -Wno-missing-braces -D DOCA_ALLOW_EXPERIMENTAL_API sequential_sample.c ../../common.c ../../../applications/common/src/utils.c -I../../../applications/common/src/ -I../ -I../../ -I ../../../ -I../../../include/ -ldoca_common -ldoca_dma -ldoca_sha -o sequential_sample
